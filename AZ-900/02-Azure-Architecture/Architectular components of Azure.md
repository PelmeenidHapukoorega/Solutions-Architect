...
It exists in order to allow businesses and developers to build, manage applications and services globally using microsofts vast infra and integrated tools, offering a massive alternative to building and maintaining their own data centers.

### What does it do?

It provides users with a vast collection of over 200 integrated services that allow organizations to build, run and manage apps and infra over the internet.

### How does it work?

It works by using massive, globally distributed network of microsoft managed data centers to host and deliver a collection of integrated services, that you as the user can access and control over the internet.
